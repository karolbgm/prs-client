      ...
      <div className="request-header">
        <div className="column1 w-75">
          <div className="mb-3">
            ...
            />
            <div className="invalid-feedback">{errors?.description?.type === "required" && "Description is required"}</div>
          ...
          <div className="mb-3">
            ...
            />
            <div className="invalid-feedback">{errors?.justification?.type === "required" && "Justification is required"}</div>
          <div className="invalid-feedback">
        ...
        <div className="column2 w-50">
          <div className="mb-3">
            ...
            <select id="delivery" className={`form-select ${errors.deliveryMode && "is-invalid"}`}
            ...
            <div className="invalid-feedback">{errors?.deliveryMode?.type === "required" && "Delivery Mode is required"}</div>
          </div>
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <input id="user" disabled className="form-control" {...register("userId")}/>
          </div>
        </div>
      </div>
